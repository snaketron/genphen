...
namespace model_cont_univ_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cont_univ");
    reader.add_event(23, 21, "end", "model_cont_univ");
    return reader;
}

#include <meta_header.hpp>
 class model_cont_univ : public prob_grad {
private:
    int Z;
    vector_d Y;
    vector_d X;
public:
    model_cont_univ(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cont_univ_namespace::model_cont_univ";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "Y", "vector_d", context__.to_vec(Z));
            validate_non_negative_index("Y", "Z", Z);
            Y = vector_d(static_cast<Eigen::VectorXd::Index>(Z));
            vals_r__ = context__.vals_r("Y");
            pos__ = 0;
            size_t Y_i_vec_lim__ = Z;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(student_t_log<propto__>(Y, nu, add(alpha,multiply(beta,X)), sigma));
            current_statement_begin__ = 17;
            lp_accum__.add(normal_log<propto__>(alpha, 0, 100));
            current_statement_begin__ = 18;
            lp_accum__.add(normal_log<propto__>(beta, 0, 10));
            current_statement_begin__ = 19;
            lp_accum__.add(gamma_log<propto__>(nu, 2.0, 0.10000000000000001));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_cont_univ_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cont_univ_namespace::model_cont_univ stan_model;
