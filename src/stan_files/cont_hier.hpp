...
namespace model_cont_hier_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cont_hier");
    reader.add_event(59, 57, "end", "model_cont_hier");
    return reader;
}

#include <meta_header.hpp>
 class model_cont_hier : public prob_grad {
private:
    int Z;
    int S_N;
    vector<int> S;
    ...
    vector<int> X;
public:
    model_cont_hier(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cont_hier_namespace::model_cont_hier";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "Y", "double", context__.to_vec(Z));
            validate_non_negative_index("Y", "Z", Z);
            Y = std::vector<double>(Z,double(0));
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= Z; ++i) {
                ...
                lp_accum__.add(student_t_log<propto__>(get_base1(Y,i,"Y",1), nu, (get_base1(alpha,get_base1(S,i,"S",1),"alpha",1) + (get_base1(beta,get_base1(S,i,"S",1),"beta",1) * get_base1(X,i,"X",1))), sigma));
            }
            ...
            lp_accum__.add(gamma_log<propto__>(nu, 2, 0.10000000000000001));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_cont_hier_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cont_hier_namespace::model_cont_hier stan_model;
